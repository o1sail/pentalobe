        ...
        <>
            <div className={`baseC ${isNavOpened ? "navIsOpened" : "navIsClosed"}`}>
                ...
                <div className={`navMenuC ${isNavOpened ? "showNav" : "hideNav"}`} onClick={() => menuFunction()}>
                    <NavigationMenu onRepairingFlow="onRepairingFlow"/> {/*ページ別編集*/}
                </div>
                    ...
                    <ul className="rpC">
                            ...
                            <div className="rpContentC">
                                ...
                                <div className="rpArticleC">
                                    ...
                                    <p className="rpArticleP">
                                        ...
                                        ・操作してないのに勝手に動く<br />
                                        ・水没した<br />
                                        ・自分で修理したら治らなくなった…など<br />
                                        <br />
                                        対応している修理一覧は<Link href="/"><a>こちら</a></Link>から
                                    </p>
                                </div>
                            </div>
                        ...
                        <li className="rpLi">
                            ...
                            <div className="rpContentC">
                                ...
                                <div className="rpArticleC">
                                    <p className="rpArticleTitleP">ペンタローブにご相談</p>
                                    <p className="rpArticleP">
                                        ・<a href="tel:080-1234-5678">お電話</a><br />
                                        ・<a href="mailto:pentalobe.repair@gmail.com">メール</a><br />
                                        ・LINEトーク<br />
                                        ・LINE電話<br />
                                        ・Instagram DM<br />
                                        ・Facebook<br />
                                        ・<Link href="/contact"><a>HPのお問い合わせフォーム</a></Link><br />
                                        <br />
                                        お問い合わせ先一覧は<Link href="/contact"><a>こちら</a></Link>から
                                    </p>
                                </div>
                            </div>
                        ...
                        <li className="rpLi">
                            ...
                            <div className="rpContentC">
                                ...
                                <div className="rpArticleC">
                                    <p className="rpArticleTitleP">ご依頼内容を確認して、お見積もり</p>
                                    <p className="rpArticleP">
                                        ・修理したい機種<br />
                                        ・修理内容<br />
                                        ・希望日時<br />
                                        ・修理場所<br />
                                        などをお伺いしたのち、修理可能であればお見積もり金額を提示させていただきます。<br />
                                        <br />
                        ...
                        <li className="rpLi">
                            ...
                            <div className="rpContentC">
                                ...
                                <div className="rpArticleC">
                                    <p className="rpArticleTitleP">指定された場所に伺います</p>
                                    <p className="rpArticleP">「こんにちは、ペンタローブのペン太郎です！」</p>
                                </div>
                            </div>
                        ...
                        <li className="rpLi">
                            ...
                            <div className="rpContentC">
                                ...
                                <div className="rpArticleC">
                                    <p className="rpArticleTitleP">修理物の状態を確認、修理同意書にサイン</p>
                                    <p className="rpArticleP">
                                        ・ガラス<br />
                                        ・フロントパネル<br />
                                        ・スピーカー<br />
                                        ...
                                        ・充電コネクタ<br />
                                        ・バイブレーション<br />
                                        などの修理前状態を確認して、改めて正確な値段を提示させていただきます。<br />
                                        問題がないようでしたら同意書にサインしていただき、修理を開始させていただきます。<br />
                                        修理許可書の内容は<Link href="/contact"><a>こちら</a></Link>からご確認いただけます
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="rpContentC">
                                ...
                                <div className="rpArticleC">
                                    ...
                                    <p className="rpArticleP">
                                        ...
                                        割引一覧は<Link href="/contact"><a>こちら</a></Link>から
                                    </p>
                                </div>
                            </div>
                        ...
                        <li className="rpLi">
                            ...
                            <div className="rpContentC">
                                ...
                                <div className="rpArticleC">
                                    <p className="rpArticleTitleP">修復できなかった場合</p>
                                    <p className="rpArticleP">
                                        ③で提示させていただいたお見積もり金額のうちの交通費のみお支払いいただきます。<br />
                                        ご了承よろしくお願いいたします。
                                    </p>
                                </div>
                            </div>
