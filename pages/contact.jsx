                    ...
                    <ul className="contactUl">
                        ...
                        <li className="contactLi">
                            ...
                            <form name="form" onSubmit={handleSubmit(onConfirm)}>
                                <label>お名前(必須)</label>
                                {errors.name && (
                                    <p className="validateP">お名前を入力してください。</p>
                                )}
                                <input
                                    type="text"
                                    name="name"
                                ...
                                {errors.email && (
                                    <p className="validateP">メールアドレスを入力してください。</p>
                                )}
                                <input
                                    type="text"
                                    name="email"
                                ...
                                {errors.model && (
                                    <p className="validateP">修理モデルと色を入力してください。</p>
                                )}
                                <input
                                    type="text"
                                    name="model"
                                ...
                                {errors.message && (
                                    <p className="validateP">修理内容もしくは不具合内容を入力してください。</p>
                                )}
                                <textarea
                                    rows="3"
                                    name="message"
...
//         if (inputs.name && inputs.email && inputs.model && inputs.message) {
